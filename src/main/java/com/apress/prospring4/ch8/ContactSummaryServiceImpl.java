...
public class ContactSummaryServiceImpl implements ContactSummaryService {
    ...
    public List<ContactSummary> findAll() {
        List<ContactSummary> result = em.createQuery("select " +
                        "new com.apress.prospring4.ch8.ContactSummary(c.firstName, c.lastName, t.telNumber) " +
                        "from Contact c " +
                        "left join c.contactTelDetails t " +
